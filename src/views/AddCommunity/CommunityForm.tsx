                ...
                <Card padding={1.5}>
                    ...
                    <Box mt={1.5}>
                        <Input
                            ...
                            name="description"
                            placeholder={
                                communityDescriptionPlaceholder?.length > 0
                                    ? communityDescriptionPlaceholder[0]?.text
                                    : ''
                            }
                            rows={6}
                    ...
                    {(!communityStatus || communityStatus === 'pending') && (
                        <Box mt={1.5}>
                            <GooglePlaces
                                ...
                                disabled={isLoading}
                                hint={
                                    errors?.location ? t('fieldRequired') : ''
                                }
                                label={t('cityCountry')}
                                name="location"
                    ...
                    <Box mt={1.5}>
                        <Text g700 mb={0.5} medium small>
                            <String id="communityCoverImage" />
                        </Text>
                        <InputUpload
