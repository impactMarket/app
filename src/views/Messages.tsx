import { Box, Button, Col, Display, Divider, Dot, Icon, Input, Label, Row, Text, Typing, ViewContainer } from '@impact-market/ui';
    ...
    <ViewContainer isLoading={isLoading}>
        <Row h="100%">
            <Col bgColor="g25" colSize={{sm: 5, xs: 12}} pb={0} pt={0}>
                ...
                <Input icon="search" placeholder="Search" wrapperProps={{ mt: 1.2 }} />
            ...
            <Col colSize={{sm: 7, xs: 12}} pb={0} pt={0}>
                <Box column fLayout="between" flex h="100vh">
                    <Box>
                            ...
                            <Box fLayout="center start" flex>
                                ...
                                <Box>
                                    <Box flex>
                                        ...
                                        <Label content="online" margin={0} success />
                                    </Box>
                        ...
                        <Box fLayout="start" flex pb={1} w="100%">
                            ...
                            <Box fLayout="start" flex w="100%">
                                <Box maxW="70%" minW="60%">
                                    ...
                                    <Box bBottomLeftRadius={0.5} bBottomRightRadius={0.5} bTopRightRadius={0.5} bgColor="g200" w="100%">
                                        <Text pb={0.625} pl={0.875} pr={0.875} pt={0.625}>
                                            Hello 
                                        </Text>
                                    </Box>
                                </Box>
                        ...
                        <Box fLayout="end" flex pb={1} w="100%">
                            <Box maxW="70%" minW="40%">
                                ...
                                <Box bBottomLeftRadius={0.5} bBottomRightRadius={0.5} bTopLeftRadius={0.5} bgColor="p500" w="100%">
                                    <Text pb={0.625} pl={0.875} pr={0.875} pt={0.625} sColor="g25">
                                        Hello
                                    </Text>
                                </Box>
                        ...
                        <Box fLayout="start" flex pb={1} w="100%">
                            ...
                            <Box fLayout="start" flex w="10%">
                                <Box>
                                    ...
                                    <Box bBottomLeftRadius={0.5} bBottomRightRadius={0.5} bTopRightRadius={0.5} bgColor="g200" w="100%">
                                        <Text pb={0.625} pl={0.875} pr={0.875} pt={1}>
                                            <Typing />
                                        </Text>
                                    </Box>
                                </Box>
                    ...
                    <Box>
                        <Input button={<Button onClick={function noRefCheck(){}}>Send</Button>} rows={3} wrapperProps={{ mt: 2 }} />
                    </Box>
