...
const ProgressBarComponent: React.FC<{ communityEntity: any, currency: string, language: string }> = props => {
    const { communityEntity, currency, language } = props;
    const { t } = useTranslations();
    const goal = communityEntity?.beneficiaries * communityEntity?.maxClaim || 0;
