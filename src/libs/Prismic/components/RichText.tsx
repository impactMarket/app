...
const serializer: SerializerFunction = ({
    ...
    if (type === 'image') {
        return (
            <Box style={{ position: 'relative'}}>
                <Box style={{height: '38rem', maxHeight: '100%', position: 'relative'}}>
                    <img src={node.url} style={{maxWidth: '100%', position: 'relative', zIndex: 1}} width="100%" />
                    <LoadingWrapper style={{background: 'white', height: '99%', position: 'absolute', top: '0', width: '100%', zIndex: '0'}}>
    ...
    // Remove support to prefformated (iframes)
    // 
