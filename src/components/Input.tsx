    ...
    const renderInput = (field?: any) => {
        return (
            <>
                ...
                <BaseInput maxLength={limit} minLength={min} {...field} onChange={(e: any) => field && setValue(e, field.onChange)} {...forwardProps} />
                { field && limit && <Text g500 mt={0.375} small>{limit - count} {t('charactersLeft')}{min && count < min && ` (min ${min})`}</Text> }
            </>
        );
    }
