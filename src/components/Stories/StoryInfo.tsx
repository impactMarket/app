...
const StoryInfo = (props: any) => {
    const { comments, handleClose, story, onloveStory, items, onComment } = props;
        ...
        <>
            ...
            <Box mt={1}>
                <GridStyled>
                    ...
                    <Box className="numbers" g600 style={{ gridArea: 'numbers'}}>
                        <Text regular small>
                    ...
                    <CanBeRendered types={['beneficiary', 'manager']}>
                        <Box ml="auto" style={{ gridArea: 'report'}}  tAlign="right">
                            <Box>
